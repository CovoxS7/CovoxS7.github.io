...
export default class Einkaufsliste {
    ...
    _html_generieren() {
        ...
        einkaufslisten_container.insertAdjacentElement("afterbegin", artikel_hinzufuegen);
        ...
        einkaufslisten_container.insertAdjacentElement("beforeend", artikel_entfernen);
